...
const studentsSeed = [
  { id: 1, name: "Ava", level: "Year 7", interests: ["Fractions", "Geometry", "Puzzles"], goal: "Find a study buddy for weekly problem solving.", bio: "I like fun visual maths and short challenge questions.", availability: "Weekends" },
  { id: 2, name: "Noah", level: "Year 7", interests: ["Algebra", "Games"], goal: "Practice algebra after school.", bio: "I enjoy turning maths into games.", availability: "Mon & Wed" },
  { id: 3, name: "Mia", level: "Year 9", interests: ["Geometry", "Olympiad", "Logic"], goal: "Join a small challenge group.", bio: "I love hard problems and patterns.", availability: "Tue & Thu" },
  { id: 4, name: "Liam", level: "Year 9", interests: ["Algebra", "Functions"], goal: "Prepare for tests with classmates.", bio: "I want to get more confident before exams.", availability: "After school" },
  { id: 5, name: "Ella", level: "Year 11", interests: ["Calculus", "Probability"], goal: "Talk through hard exam questions.", bio: "I like step-by-step explanations and exam strategies.", availability: "Friday afternoons" },
];

const postsSeed = [
  { id: 1, author: "Ava", level: "Year 7", text: "Who wants to solve 3 fun geometry puzzles this weekend?", tags: ["Geometry", "Puzzles"] },
  { id: 2, author: "Mia", level: "Year 9", text: "I made a small logic challenge. Want to try it together?", tags: ["Logic", "Challenge"] },
  { id: 3, author: "Ella", level: "Year 11", text: "Looking for someone to revise derivatives with after class.", tags: ["Calculus"] },
];

const groupsSeed = [
  { id: 1, name: "Year 7 Puzzle Club", level: "Year 7", topic: "Puzzles", members: 12, meeting: "Saturday 10:00 AM", description: "A friendly group for puzzle lovers who enjoy short challenge questions.", posts: ["Welcome to Puzzle Club!", "Bring one favourite puzzle to share this week."] },
  { id: 2, name: "Year 9 Algebra Circle", level: "Year 9", topic: "Algebra", members: 8, meeting: "Wednesday 4:30 PM", description: "Work through algebra skills together and prepare for tests.", posts: ["This week: simplifying expressions.", "Post one tricky algebra question below."] },
  { id: 3, name: "Year 11 Calculus Crew", level: "Year 11", topic: "Calculus", members: 10, meeting: "Friday 5:00 PM", description: "Practice derivatives and exam-style questions as a team.", posts: ["Friday focus: derivative rules.", "Share one exam tip before the session."] },
];
  ...
  "Year 7": [
    {
      topic: "Fractions",
      sets: [
        { title: "Practice Set 1", questions: [
          { id: 1, question: "1/2 + 1/4 = ?", answer: "3/4", explanation: "Convert to quarters: 1/2 = 2/4, then 2/4 + 1/4 = 3/4.", commonMistake: "Forgetting to use the same denominator before adding." },
          { id: 2, question: "3/5 - 1/5 = ?", answer: "2/5", explanation: "The denominator stays 5, so subtract only the numerators.", commonMistake: "Subtracting both numerator and denominator." },
        ]},
        { title: "Challenge Set", questions: [
          { id: 3, question: "Which is greater: 2/3 or 3/5?", answer: "2/3", explanation: "Compare decimals: 2/3 ≈ 0.667 and 3/5 = 0.6.", commonMistake: "Comparing only the denominators instead of the values." },
        ]},
      ],
    },
    {
      ...
      sets: [
        { title: "Practice Set 1", questions: [
          { id: 4, question: "0.7 + 0.25 = ?", answer: "0.95", explanation: "Align decimal places before adding.", commonMistake: "Misaligning decimal places." },
          { id: 5, question: "1.2 - 0.8 = ?", answer: "0.4", explanation: "Subtract tenths carefully: 12 tenths - 8 tenths = 4 tenths.", commonMistake: "Ignoring place value." },
        ]},
      ],
    },
  ],
  "Year 9": [
    {
      ...
      sets: [
        { title: "Practice Set 1", questions: [
          { id: 6, question: "Simplify: 3x + 2x", answer: "5x", explanation: "Combine like terms by adding the coefficients.", commonMistake: "Writing 6x^2 instead of combining like terms." },
          { id: 7, question: "Solve: x + 4 = 11", answer: "x = 7", explanation: "Subtract 4 from both sides.", commonMistake: "Adding 4 instead of subtracting it." },
        ]},
      ],
    },
    {
      ...
      sets: [
        { title: "Practice Set 1", questions: [
          { id: 8, question: "What is the sum of angles in a triangle?", answer: "180°", explanation: "The interior angles of any triangle always add to 180°.", commonMistake: "Confusing a triangle with a quadrilateral." },
        ]},
      ],
    },
  ],
  "Year 11": [
    {
      ...
      sets: [
        { title: "Practice Set 1", questions: [
          { id: 9, question: "Differentiate: x^2", answer: "2x", explanation: "Use the power rule: d/dx(x^n) = nx^(n-1).", commonMistake: "Keeping the exponent as 2 after differentiating." },
          { id: 10, question: "Differentiate: 5x^3", answer: "15x^2", explanation: "Multiply by the power, then reduce the exponent by 1.", commonMistake: "Forgetting to multiply by the original coefficient 5." },
        ]},
      ],
    },
  ],
...
export default function App() {
  ...
  const openTopic = (index) => {
    ...
    setVisibleAnswers({});
    setCheckedAnswers({});
    setTimeout(() => document.getElementById("practice-section")?.scrollIntoView({ behavior: "smooth", block: "start" }), 50);
  };
                  ...
                  <div id="practice-section" style={{ ...styles.card, marginTop: "20px" }}>
                    ...
                    <div style={{ marginTop: "10px", marginBottom: "16px" }}>
                      {activePracticeTopic.sets.map((setItem, index) => (
                        <button key={setItem.title} style={styles.pillButton(selectedSetIndex === index)} onClick={() => { setSelectedSetIndex(index); setVisibleAnswers({}); setCheckedAnswers({}); }}>
                          {setItem.title}
                        </button>
                      ))}
                    </div>
